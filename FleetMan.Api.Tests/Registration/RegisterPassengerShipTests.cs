...
public class ShipsControllerTests(WebApplicationFactory<Program> factory) : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    public async Task Given_ValidInput_When_RegisteringNewShip_Then_ReturnsResult()
    {
        ...
        // Act
        var response = await _client.PostAsJsonAsync("/ships/passenger", request);
